...
void Page_Load(object sender, EventArgs e) {
	...
	XmlDocument downloads = new XmlDocument();
	...
	foreach(XmlElement item in items) {
		...
		itemLinkElement.InnerText = "http://www.microsoft.com/en-us/download/" + item.SelectSingleNode("*[local-name()='div'][@class='link']").FirstChild.Attributes["href"].InnerText + "#tm";
